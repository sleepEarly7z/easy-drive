...
function FilterList() {
  ...
  return (
    <div className='FilterList'>
      ...
      <ProfileCard name={'Trump'} location={'USA'} years={'3'} rate={'2'} imgSrc={"https://pinchaninch.co.uk/wp-content/uploads/2016/11/donald-trump-incapable-of-embarrassment-r_0.jpg"}/><br />
    </div>
  )
}
